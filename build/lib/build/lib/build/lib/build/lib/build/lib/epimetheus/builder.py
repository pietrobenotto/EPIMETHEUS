...
class EPIBuilder:
    ...
    def _align_star_internal(self, 
        ...
        reduced_image, reduced_wht = align_and_rotate_star(
            ...
            final_size=self.cutouts.final_size,
    ...
    def _fit_shift_to_original(self,
        ...
        if result.success:
            ...
            cx, cy = centroid_2dg(data, error=error)
    ...
    def build_multi_angle_epsf(self,
        ...
        if output_shape is not None:
            ...
            original_shape = np.asarray(self.cutouts.final_size)
            ...
            start = center_index(original_shape - output_shape)
